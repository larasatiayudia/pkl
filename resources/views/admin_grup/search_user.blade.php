...
<div class="container-fluid">
  ...
  <ul class="breadcrumbs ">
    ...
    <li class="active"><a href="javasript:void(0)"> Pencarian User</a></li>
  </ul> 
            ...
            <tr>
              ...
              <td> 
                <p data-placement="top" data-toggle="tooltip" title="Edit">
                  <button class="btn btn-primary open_modal" data-title="Edit" data-toggle="modal" data-target="#editUser" data-nip="{{$user->NIP}}" data-id="{{$user->id_user}}" data-nama="{{$user->Nama}}" data-tipekantor="{{$user->kantor->tipe_kantor}}" data-kantor="{{$user->id_kantor}}" data-jabatan="{{$user->id_jabatan}}" data-username="{{$user->username}}">
              ...
              <td>
                <form id="deleteform" class="delete" role="form" method="POST" action="{{route('admingrup.deleteUser',['id'=>$user->id_user])}}" enctype="multipart/form-data">
                  <p data-placement="top" data-toggle="tooltip" title="Delete"> 
                    ...
                    <button class="btn btn-danger" type="button" id="delete" data-name="{{$user->Nama}}" data-table="User">
      ...
      <div class="modal-body">
        <form role= "form" id="" method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input id="password" name="password" type="text" required class="form-control" placeholder="Masukkan password" value="{{str_random(6)}}" onchange="validasipassword()" onkeyup="validasipassword2()" />
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <!--NIP-->
          ...
          <div class="form-group">
            <label class="control-label">Password</label>
            <input id="password" name="password" type="text" class="form-control" placeholder="Masukkan password baru(kosongkan bila tidak ingin mengubah)" value="" onchange="validasipassword()" onkeyup="validasipassword2()" />
            <span id="needmore" style="color: red"></span>
            <h6>min 6 karakter</h6>
          </div>
          <!--User-->
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
        <button id="submit" type="submit" class="btn btn-primary"> Save Change</a>
      </div>
          {{csrf_field()}} 
        </form>
    </div><!-- /.modal-content -->
...
<script type="text/javascript">
 ...
 <script type="text/javascript">
    ...
    // function generateNIP(obj){
    //     var NIP = obj.value;
    //     if(obj.value==""){
    //       document.getElementById("username").setAttribute("value", "");
    //     }
    //     else{
    //       document.getElementById("username").setAttribute("value", NIP);
    //     }
    // }
