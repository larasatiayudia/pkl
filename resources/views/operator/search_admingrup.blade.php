...
@section('title', 'Search | Admin Grup')
     ...
     <div class="col-md-12">
      <div class="page-title">
        <ol class="breadcrumb judulmenu"><br><br>
         <li class="active" style="color:#E5FFCA"><h3><b><i class="fa fa-users"></i> Admin Grup</b></h3></li>
        </ol>
       </div>
      </div>
     </div>
   ...
   <div class="form-group">
    <div class="row">
      <div class="col-md-12">
        ...
        <!--Table Data-->               
        <h3 style="margin-top: -15px">Hasil Pencarian untuk: {{$q}}</h3>
