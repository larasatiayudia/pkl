...
<div class="container">
	...
	<ul class="breadcrumbs hidden-xs">
        ...
        @endif
        <li class="active"><a href="javascript:void(0);">Form Modul</a></li>
    </ul>
			...
			@include('admin.stepadmin')
                ...
                <div class="panel panel-form">
                    ...
                    <div class="panel-body">
                        ...
                        <form role="form" method="POST" enctype="multipart/form-data" action="{{ url('/tambahmodul') }}">
                        {{csrf_field()}}
                        ...
                        <!-- Edit Modul -->
                        @else
                        <form role="form" method="POST" enctype="multipart/form-data" action="{{ url('/editmodul') }}">
                        {{csrf_field()}}
                ...
                @else
                <a href="{{url('/formtest/'.Hashids::encode($materi->id_mat,$status))}}" class="btn btn-success" id="next">Next</a>
                @endif
		</div>
	</div>
</div>
