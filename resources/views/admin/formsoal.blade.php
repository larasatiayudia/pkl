...
<div class="container">
    ...
    <ul class="breadcrumbs hidden-xs">
        ...
        @if($status)
        <li class="completed"><a href="{{url('/materisoal/'.Hashids::encode($test->materi->id_jabatan,$status))}}">Materi Periode</a></li>
        @else
        <li class="completed"><a href="{{url('/materisoal/'.Hashids::encode($test->materi->id_jabatan,$status))}}">Materi In Class</a></li>
        @endif
        <li class="active"><a href="javascript:void(0);">Form Soal</a></li> 
    </ul>
            ...
            <div class="panel panel-form">
                <div class="panel-heading">Soal</div>
                    <div class="panel-body">
                        ...
                        <a href="{{url('/finishcreate/'.$test->materi->id_mat)}}" type="button" class="btn btn-success pull-right"><i class="fa fa-check-circle" aria-hidden="true"></i> Finish</a>
                        <br><br>
                        <!-- Klo jumlah soal yang dibuat >= jumlah soal test yang udah ditentuin -->
                        @elseif(!$status && $soals->total() >= $test->jumlah_soal)
                        <a href="{{url('/tipetes/'.Hashids::encode($test->materi->id_mat,$status))}}" type="button" class="btn btn-success pull-right"><i class="fa fa-check-circle" aria-hidden="true"></i> Finish</a>
                        <br><br>
                        @else
                        <!-- Klo jumlah soal yang dibuat < jumlah soal test yang udah ditentuin -->
                                  ...
                                  <div class="panel-body" id="1" style="background-color: #BBF68E; border: 2px solid #01573C;border-radius: 40px"><br>
                                    ...
                                    <!-- nomor untuk mobile -->
                                        ...
                                        <div class="col-md-2 col-xs-2">
                                            <form id="deleteform" role="form" method="POST" enctype="multipart/form-data" action="{{ url('/soal/'.$soal->id_soal) }}">
                                            {{ csrf_field() }}
                            ...
                            <div class="modal-content">
                               <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form role="form" method="POST" enctype="multipart/form-data"  action="{{ url('/tambahsoal') }}">
                                    {{csrf_field()}}
                            ...
                            <div id="editModal" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
                              <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                  ...
                                  <div class="container">
                                    <form role="form" method="POST" enctype="multipart/form-data" action="{{ url('/editsoal') }}">
                                    {{csrf_field()}}
